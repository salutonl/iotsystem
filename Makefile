...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Jul 20 11:58:58 2017
# Project:  GateWay.pro
# Template: app
# Command: /opt/QtSDK/Desktop/Qt/4.8.1/gcc/bin/qmake -o Makefile GateWay.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		serialservice.cpp \
		enddevice.cpp \
		all_the_msg.cpp moc_mainwindow.cpp \
...
Makefile: GateWay.pro  /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/default/qmake.conf /opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/linux.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/gcc-base-unix.conf \
		/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.h posix_qextserialport.h qextserialbase.h serialservice.h enddevice.h all_the_msg.h .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp posix_qextserialport.cpp qextserialbase.cpp serialservice.cpp enddevice.cpp all_the_msg.cpp .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/GateWay1.0.0/ && (cd `dirname .tmp/GateWay1.0.0` && $(TAR) GateWay1.0.0.tar GateWay1.0.0 && $(COMPRESS) GateWay1.0.0.tar) && $(MOVE) `dirname .tmp/GateWay1.0.0`/GateWay1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GateWay1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_qextserialbase.cpp moc_serialservice.cpp moc_enddevice.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_qextserialbase.cpp moc_serialservice.cpp moc_enddevice.cpp
...
all_the_msg.o: all_the_msg.cpp all_the_msg.h \
		enddevice.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o all_the_msg.o all_the_msg.cpp
